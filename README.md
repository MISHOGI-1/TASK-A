...
- `image_evidence/` - screenshots used as proof in this README
...
> All screenshots referenced below are stored in the `image_evidence/` folder next to this README so they render correctly on GitHub.
...
![Figure A1 - Compile output](image_evidence/succesfull_compile_output_1.png)
...
![Figure A2 - Vulnerable normal run](image_evidence/shows_vulnerable_run_with_normal_admin_input_2.png)
...
![Figure A3 - Overflow evidence](image_evidence/full_terminal_output_proving_overflow_evidence_3.png)
...
![Figure A4 - Fixed valid admin](image_evidence/ixed_program_accepts_valid_admin_correctly._4.png)
...
![Figure A5 - Fixed denies non-admin](image_evidence/fixed_program_blocks_non-admin_user._5.png)
...
![Figure A6 - Fixed safe overflow handling](image_evidence/fixed_program_safely_rejects_long_input._6.png)
...
![Figure A7 - Flawfinder before fix](image_evidence/Flawfinder_before_fix.png)
...
![Figure A8 - Flawfinder after fix](image_evidence/flawfinder_after_fix.png)
